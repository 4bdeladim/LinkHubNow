...
export default function Bio() {
    ...
    const [error, setError] = useState<{type: "danger" | "success", msg: string} | null>(null);
        ...
        <div className="w-full flex flex-col h-[calc(100vh - 80px)] flex justify-center items-center">
            {
                isLoading ? <Loading /> : 
                    <>
                        ...
                        data?.image ? (
                            ...
                            />
                                ...
                                width="180"
                                height="180"
                                src="https://www.minimalavatars.com/logo192.png"
                                alt="Avatar"
                                className="border rounded-full"
                            />
                        }
                    ...
                    { error && <Toast toastType={error.type} message={error.msg} /> }
                    </>
            }
