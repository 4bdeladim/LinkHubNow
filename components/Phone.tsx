export default function Phone(){
    return (
        <svg className="absolute top-1/2 right-1/2 translate-x-1/2 -translate-y-1/2" width="308" height="632" viewBox="0 0 308 632" fill="none" xmlns="http://www.w3.org/2000/svg">
